...
const PROGRAMS: SeedProgram[] = [
  ...
  { cat: "spa", photo: "/programs/antistress.webp", n: { ru: "Антистресс", kk: "Антистресс", en: "Anti-Stress" }, d: { ru: "SPA-программа на двоих, 3 часа", kk: "Екі адамға SPA, 3 сағат", en: "Spa program for two, 3 hours" }, opts: [{ pers: 2, p: 88000 }] },
  { cat: "spa", photo: "/programs/energiya-siama.webp", n: { ru: "Энергия Сиама", kk: "Сиам энергиясы", en: "Energy of Siam" }, d: { ru: "SPA-программа, 2 часа", kk: "SPA бағдарламасы, 2 сағат", en: "Spa program, 2 hours" }, opts: [{ m: 120, p: 35000 }] },
  { cat: "spa", photo: "/programs/perezagruzka.webp", n: { ru: "Перезагрузка", kk: "Қайта жүктелу", en: "Reboot" }, d: { ru: "SPA-программа, 3 часа", kk: "SPA бағдарламасы, 3 сағат", en: "Spa program, 3 hours" }, opts: [{ m: 180, p: 55000 }] },
  { cat: "spa", photo: "/programs/spa-relaks.webp", n: { ru: "Спа Релакс", kk: "Спа Релакс", en: "Spa Relax" }, d: { ru: "SPA-программа, 1 час", kk: "SPA бағдарламасы, 1 сағат", en: "Spa program, 1 hour" }, opts: [{ m: 60, p: 20000 }] },
