...
const PROGRAMS: SeedProgram[] = [
  ...
  { cat: "massage", photo: "/programs/massazh-golovy-i-shei.webp", n: { ru: "Массаж головы и шеи", kk: "Бас пен мойын массажы", en: "Head & Neck Massage" }, d: { ru: "Расслабляющий Oil массаж", kk: "Босаңсытатын Oil массажы", en: "Relaxing oil massage" }, opts: [{ m: 60, p: 18000 }] },
  { cat: "massage", photo: "/programs/chudesnoe-ozhidanie.webp", n: { ru: "Чудесное ожидание", kk: "Ғажайып күту", en: "Wonderful Expectation" }, d: { ru: "Расслабляющий массаж для беременных", kk: "Жүкті әйелдерге арналған массаж", en: "Relaxing prenatal massage" }, opts: [{ m: 60, p: 24000 }, { m: 90, p: 30000 }] },
  ...
  { cat: "spa", pop: true, photo: "/programs/strana-ulybok.webp", n: { ru: "Страна улыбок", kk: "Күлкі елі", en: "Land of Smiles" }, d: { ru: "SPA для подруг, 3 часа: скраб, обёртывание, маска для лица, Oil массаж", kk: "Құрбыларға арналған SPA, 3 сағат: скраб, орау, бет маскасы, Oil массажы", en: "Girls' spa, 3 hours: scrub, body wrap, facial mask, oil massage" }, opts: [{ pers: 2, p: 90000 }, { pers: 3, p: 132000 }] },
  { cat: "spa", pop: true, photo: "/programs/ty-i-ya.webp", n: { ru: "Ты и Я", kk: "Сен және Мен", en: "You & Me" }, d: { ru: "SPA для пар, 2,5 часа: скраб, Oil массаж и массаж головы", kk: "Жұптарға арналған SPA, 2,5 сағат: скраб, Oil массажы және бас массажы", en: "Couples spa, 2.5 hours: scrub, oil massage and head massage" }, opts: [{ pers: 2, p: 70000 }] },
  { cat: "spa", photo: "/programs/antistress.webp", n: { ru: "Антистресс", kk: "Антистресс", en: "Anti-Stress" }, d: { ru: "SPA для двоих, 3 часа: пенный массаж, скраб, Oil массаж и массаж стоп", kk: "Екі адамға SPA, 3 сағат: көбік массажы, скраб, Oil және табан массаждары", en: "Spa for two, 3 hours: foam massage, scrub, oil and foot massages" }, opts: [{ pers: 2, p: 88000 }] },
  { cat: "spa", photo: "/programs/energiya-siama.webp", n: { ru: "Энергия Сиама", kk: "Сиам энергиясы", en: "Energy of Siam" }, d: { ru: "SPA на 2 часа: пенное очищение, скраб и Oil массаж", kk: "SPA, 2 сағат: көбікпен тазарту, скраб және Oil массажы", en: "Spa, 2 hours: foam cleansing, scrub and oil massage" }, opts: [{ m: 120, p: 35000 }] },
  { cat: "spa", photo: "/programs/perezagruzka.webp", n: { ru: "Перезагрузка", kk: "Қайта жүктелу", en: "Reboot" }, d: { ru: "SPA на 3 часа: пилинг, скраб и двухчасовой Oil массаж", kk: "SPA, 3 сағат: пилинг, скраб және 2 сағаттық Oil массажы", en: "Spa, 3 hours: peeling, scrub and 2 hours of oil massage" }, opts: [{ m: 180, p: 55000 }] },
  { cat: "spa", photo: "/programs/spa-relaks.webp", n: { ru: "Спа Релакс", kk: "Спа Релакс", en: "Spa Relax" }, d: { ru: "SPA на 1 час: пилинг, скраб и мытьё головы", kk: "SPA, 1 сағат: пилинг, скраб және бас жуу", en: "Spa, 1 hour: peeling, scrub and hair wash" }, opts: [{ m: 60, p: 20000 }] },
  { cat: "set", pop: true, photo: "/programs/sabai-sabai.webp", n: { ru: "Sabai Sabai", kk: "Sabai Sabai", en: "Sabai Sabai" }, d: { ru: "Сет на 2 часа: пилинг, скраб и Oil массаж", kk: "Ем-шаралар сеті, 2 сағат: пилинг, скраб және Oil массажы", en: "Treatment set, 2 hours: peeling, scrub and oil massage" }, opts: [{ m: 120, p: 38000 }, { pers: 2, p: 72000 }] },
  { cat: "set", photo: "/programs/karuna.webp", n: { ru: "Karuna", kk: "Karuna", en: "Karuna" }, d: { ru: "Сет на 2 часа: пилинг, скраб и тайский массаж", kk: "Ем-шаралар сеті, 2 сағат: пилинг, скраб және тай массажы", en: "Treatment set, 2 hours: peeling, scrub and Thai massage" }, opts: [{ m: 120, p: 36000 }, { pers: 2, p: 68000 }] },
  { cat: "set", photo: "/programs/sanuk.webp", n: { ru: "Sanuk", kk: "Sanuk", en: "Sanuk" }, d: { ru: "Сет на 1,5 часа: пилинг, скраб и массаж спины", kk: "Ем-шаралар сеті, 1,5 сағат: пилинг, скраб және арқа массажы", en: "Treatment set, 1.5 hours: peeling, scrub and back massage" }, opts: [{ m: 90, p: 28000 }, { pers: 2, p: 52000 }] },
];
